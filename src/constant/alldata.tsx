...
export const headerinfo = [
  {
    ...
    title: "Bize Ulaşın", // (istersen Türkçe yaparız: Bize Ulaşın)
    paragraph: (
  ...
  { image: IMAGES.svgicon4, title: "Supports", paragraph: "24x7 Supports" },
  {
    ...
    paragraph: (
      <span>
        Pay Online <i className="feather icon-arrow-right" />
      </span>
    ),
  },
...
/**
 * ✅ MENÜ (Senin istediğin yapı)
 * Ana Sayfa
 * Kurumsal (Özhan İnce Kimdir? / Ekibimiz / SSS / KVKK)
 * İşlemlerimiz
 * After-Before Galeri
 * Hasta Rehberi
 * İletişim
...
export const headerdata: HeaderItem[] = [
  ...
  },
  {
    ...
    content: [
      { title: "Özhan İnce Kimdir ?", to: "/about-us" },
      { title: "Ekibimiz", to: "/team" },
      { title: "Sıkça Sorulan Sorular", to: "/faqs" },
      // KVKK sayfası yoksa 404 vermesin diye şimdilik under-construction
      { title: "Kişisel Veri Gizliliği", to: "/under-construction" },
    ],
  },
  {
    title: "İşlemlerimiz",
    classChange: "sub-menu-down",
    content: [
      { title: "İşlemler", to: "/services" },
      { title: "İşlem Detay", to: "/service-detail" },
    ],
  },
  {
    title: "After - Before Galeri",
    to: "/under-construction", // sayfa açınca /gallery yaparız
  },
  {
    title: "Hasta Rehberi",
    classChange: "sub-menu-down",
...
export const footerdata2 = [
  {
    title: "Our Services",
    span1: "Emergency Care",
    span2: "Operation Theater",
    span3: "Medical Checkup",
    span4: "Diagnostic Center",
    span5: "Outdoor Checkup",
...
// component
// alllocation ✅ FIXED (EOF HATASI BURADAYDI)
...
export const mapdata = [
  {
    ...
    title: "Adres",
    para: <p>Ülke Plaza, 2. Kat, Kayseri</p>,
  },
  {
    id: 2,
    delay: "0.4s",
    ...
    para: (
      <p>
        <Link href="tel:+905001234567">+90 500 123 45 67</Link>
      </p>
    ),
  },
  {
...
export const pricingdata2 = [
  {
    delay: "0.4s",
    title: <h2 className="pricingtable-bx">Free<small>/ Lifetime</small></h2>,
    feature: (
  ...
  },
  {
    delay: "0.6s",
    coloumnstand: "active",
    title: <h2 className="pricingtable-bx">$25<small>/ Month</small></h2>,
    feature: (
      <ul className="pricingtable-features">
        <li><Image src={IMAGES.Check} alt="" /></li>
        <li><Image src={IMAGES.Check} alt="" /></li>
  ...
  {
    delay: "0.8s",
    title: <h2 className="pricingtable-bx">$40<small>/ Month</small></h2>,
    feature: (
      <ul className="pricingtable-features">
        <li><Image src={IMAGES.Check} alt="" /></li>
        <li><Image src={IMAGES.Check} alt="" /></li>
